...
def main():
    """Main function to process audio file and zero out voice segments."""
    parser = argparse.ArgumentParser(description="Remove voice segments from audio using pyannote.audio and ffmpeg")
    parser.add_argument("input_file", help="Path to input audio file")
    parser.add_argument("-o", "--output", help="Path for output audio file (default: input_filename_no_conversations.mp3)")
    ...
    try:
        ...
        print(f"Detecting voice segments in: {input_path}")
