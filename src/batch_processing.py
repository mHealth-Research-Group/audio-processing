...
Performance Issue:
- Small datasets (< 60 videos): ~90 filters → 1-3s per video ✅
- Large datasets (> 100 videos): 1000+ filters → 30-100s per video 🔴
...
class BatchProcessor:
    ...
    def _process_batch_videos(self, batch_dir: Path, batch_output: Path, batch_args) -> int:
        ...
        try:
            ...
            # Check if we have timestamped videos
